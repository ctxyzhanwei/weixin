...
<?php if($list != ''): ?><tr>
                ...
                <td align='center'>
                    <a href="<?php echo U('Aboutus/edit/',array('id'=>$list['id']));?>">修改</a>
                    | <?php if(($list["username"]) == "admin"): ?><font color="#cccccc">删除</font><?php else: ?><a href="javascript:void(0)" onclick="return confirmurl('<?php echo U('Aboutus/del/',array('id'=>$list['id']));?>','确定删除该用户吗?')">删除</a><?php endif; ?>
                </td>
            </tr><?php endif; ?>
        <style>
