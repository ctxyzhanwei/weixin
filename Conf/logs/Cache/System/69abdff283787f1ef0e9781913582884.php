...
<div id="artlist" class="addn">
		...
		<?php else: ?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					<td height="48" align="right"><strong>新功能：</strong></td>
					<td colspan="3" class="lt">
						<input type="radio" class="radio" class="ipt" value="1" name="isnew" id="status1" <?php if(($info["isnew"] == 1) OR ($info['isnew'] == '') ): ?>checked=""<?php endif; ?> >
							是
							<input type="radio" class="radio" class="ipt"  value="0" name="isnew" id="status2" <?php if(($info["isnew"]) == "0"): ?>checked=""<?php endif; ?> >
							否
					</td>
				</tr>
